            ...
            <div className="col-md-8 m-auto">
              ...
              <p className="lead text-center">Create your DevConnector account</p>
                <form noValidate onSubmit={this.onSubmit}>
                  ...
                  <div className="form-group">
                    <input type="password" className={classnames('form-control form-control-lg', {'is-invalid': errors.passwordconfirm})} placeholder="Confirm Password" name="passwordconfirm" value={this.state.passwordconfirm} onChange={this.onChange} />
